function buildMetadata(sample) {
  ...
  d3.json(metadataURL).then(function(data) {
    ...
    var data = [{domanin: {x: [0, 1], y: [0, 1]}, value: data.WREQ,
    title: {TEXT: "Belly Button", font: {size: 14}},
    type: "indicator", mode: "gauge+number+delta",
    delta: {reference: 9, increasing: {color: "green"}},
    gauge:
      {axis: {range: [0,10]}, steps: [{range: [0, 5], color: "lightgrey"},
      {range: [5,8], color: "grey"}], threshold: {line: {color: "red", width: 4},
